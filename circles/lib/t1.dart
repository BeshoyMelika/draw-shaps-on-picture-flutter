...
class MyPainterss extends CustomPainter {
  Function(String) setState;
  final BuildContext context;
  ...
  MyPainterss(this.context, this.centerPoint, this.endPoint, this.setState);
  double get calculateRadius => Point(centerPoint.dx, centerPoint.dy)
  ...
  void paint(Canvas _canvas, Size size) {
    ...
    // canvas.drawCircle(centerPoint, calculateRadius, paint, onTapDown: (_) {
    //   print("orange Circle touched");
    //   setState('orange');
    // });
    canvas.drawCircle(
        centerPoint, calculateRadius, Paint()..color = Colors.lightBlueAccent,
        onTapDown: (_) {
      print('light blue Circle tap down');
      setState('white');
    }, onTapUp: (detail) {
